    ...
    return (
        <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[30%_70%]">
            ...
            <div className="relative hidden lg:flex flex-col justify-center px-16 overflow-hidden rounded-md">
                <div className="absolute inset-0 bg-linear-to-br from-rose-600/80 via-pink-500/70 to-fuchsia-600/80" />
            ...
            {/* Right panel */}
            <div className="flex items-center justify-center w-full min-h-screen px-4 sm:px-6 bg-linear-to-br from-slate-950 via-indigo-950 to-purple-900">
                {children}
            </div>
        </div>
