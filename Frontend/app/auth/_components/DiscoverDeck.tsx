...
export default function TinderStyleDashboard({
  ...
  const [viewMode, setViewMode] = useState<"discover" | "my-profile">("discover");
        ...
        <div className="grid h-full gap-6 lg:grid-cols-[300px_1fr]">
          <aside className="flex h-full flex-col rounded-3xl border-2 border-fuchsia-500/40 bg-white p-4">
            <button
              ...
              className={`w-full rounded-2xl bg-gradient-to-r from-fuchsia-600 to-purple-600 p-3 text-white shadow transition ${
                viewMode === "my-profile" ? "ring-2 ring-fuchsia-300" : ""
              }`}
            >
            ...
            <button
              ...
              className={`mt-3 w-full rounded-2xl border px-3 py-2 text-left text-sm font-semibold transition ${
                viewMode === "discover"
